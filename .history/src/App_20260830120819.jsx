...
export default function Hero() {
  ...
  return (
    <div className="relative w-full h-screen bg-[#C8683D] overflow-hidden flex flex-col justify-between text-white font-sans select-none">
      ...
      {/* استيراد الخطوط من Google Fonts (Anton & Bebas Neue) */}
      <style>{`
      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        {/* كلمة COFFEE بخط Anton النطاط الضخم */}
        <h1 
          className="absolute text-[31vw] leading-none text-[#FAF7F2] z-0 pointer-events-none select-none -translate-y-8 tracking-[-0.01em] scale-y-[1.1]"
          style={{ 
