  ...
  return (
    <div className="relative w-full h-screen bg-[#C8683D] overflow-hidden flex flex-col justify-between text-white font-sans select-none">
      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        {/* الكأسان في المنتصف */}
        <div className="relative z-10 flex items-end justify-center -space-x-28 md:-space-x-36 translate-y-12 md:translate-y-16">
          <img 
            src="/cup1.png" 
      ...
      {/* 3. Bottom Curved White Section - انحناءة مرتفعة جداً ومجسمة */}
      <div className="relative z-40 w-full">
        <div className="w-full overflow-hidden leading-none -mb-1">
          ...
          >
            <path 
              d="M0,120 L0,100 Q600,-30 1200,100 L1200,120 Z" 
              fill="#FAF7F2"
            ></path>
          </svg>
        </div>
