  ...
  return (
    <div className="relative w-full h-screen bg-[#DE7A4D] overflow-hidden flex flex-col justify-between text-white font-sans select-none">
      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        <h1 
          className="absolute text-[31vw] leading-none text-[#FAF7F2] z-0 pointer-events-none select-none -translate-y-10 tracking-[-0.01em] scale-y-[1.1]"
          style={{ 
        ...
        {/* توزيع 11 حبة قهوة خلف الصور وبأحجام زوايا متنوعة (z-10) */}
        ...
        {/* الكأسان في المنتصف: حجم أكبر بكثير وإزاحة أعمق لأسفل (z-20) */}
        <div className="relative z-20 flex items-end justify-center -space-x-28 md:-space-x-36 translate-y-36 md:translate-y-44">
          <img 
            src="/cup1.png" 
            alt="Pink Cream Frappe" 
            className="h-[88vh] md:h-[95vh] w-auto max-w-none object-contain filter drop-shadow-[0_25px_35px_rgba(0,0,0,0.3)] z-10"
          />

          <img 
            src="/cup2.png" 
            alt="Chocolate Cream Frappe" 
            className="h-[88vh] md:h-[95vh] w-auto max-w-none object-contain filter drop-shadow-[0_25px_35px_rgba(0,0,0,0.3)] z-20"
          />
        </div>
      </div>

      {/* 3. Bottom Curved White Section (z-40 فوق الكبايات لتغطية نصفها) */}
      <div className="relative z-40 w-full -mt-20 md:-mt-28">
