  ...
  return (
    <div className="relative w-full h-screen bg-[#C8683D] overflow-hidden flex flex-col justify-between text-white font-sans select-none">
      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        {/* الكأسان متداخلان جداً وفي المنتصف وينزلان تحت الجزء الأبيض */}
        <div className="relative z-10 flex items-end justify-center -space-x-28 md:-space-x-36 translate-y-24 md:translate-y-28">
      ...
      {/* 3. Bottom White Bar (البطاقة البيضاء السفلى) */}
