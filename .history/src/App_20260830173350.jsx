        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-xs md:text-sm font-semibold text-gray-700">
              ...
              <span>1F IBM Plaza, Libis, Eastwood Avenue, Quezon City, Metro Manila</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="w-full h-[320px] rounded-3xl overflow-hidden shadow-md border border-gray-200 relative bg-gray-200">
              <iframe
                title="Location Map"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3860.535874271813!2d121.07727447590214!3d14.625529175782723!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397b79782c3c6f3%3A0x6a0fb4f3e8abf415!2sIBM%20Plaza!5e0!3m2!1sen!2sph!4v1700000000000!5m2!1sen!2sph"
            ...
            <div className="space-y-6 text-gray-700 text-sm leading-relaxed">
              <p>
                Craving your favorite coffee? We're located at{" "}
                <span className="font-semibold text-gray-900">
                  1F IBM Plaza, Libis, Eastwood Avenue, Quezon City, Metro Manila
                </span>
                — right in the heart of Eastwood! Whether you're out for a quick morning break, hanging with friends, or simply treating yourself, Nescafe Bae is just around the corner. Stop by, grab a cup, and experience the rich, creamy goodness we're known for.
              </p>
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-xs md:text-sm">09123456789</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-xs md:text-sm">@nescafebae</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-xs md:text-sm">Nescafe Bae</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-xs md:text-sm">nescafebae@gmail.com</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1.5 text-xs text-gray-600">
              ...
              <li className="flex items-center gap-2">
                <span>✉️</span>
                <span>nescafebae@gmail.com</span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-start md:items-end space-y-2">
            ...
            <span className="text-[11px] text-gray-500">
              © 2026 Nescafe Bae. All rights reserved.
            </span>
          </div>
        </div>
      </footer>
