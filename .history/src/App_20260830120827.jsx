  ...
  return (
    <div className="relative w-full h-screen bg-[#DE7A4D] overflow-hidden flex flex-col justify-between text-white font-sans select-none">
      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        {/* توزيع حبوب القهوة بزوايا وأحجام واتجاهات متنوعة */}
        <div className="absolute inset-0 z-10 pointer-events-none">
          {/* حبوب متوسطة الحجم وزوايا مختلفة (يمين ويسار) */}
          <img src="/beans.png" alt="" className="absolute top-[12%] left-[18%] w-24 -rotate-45 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[28%] left-[26%] w-28 rotate-180 drop-shadow-2xl filter blur-[1px]" />
          {/* حبة منفرجة جهة اليسار */}
          <img src="/beans.png" alt="" className="absolute top-[50%] left-[15%] w-20 scale-x-[-1] rotate-45 drop-shadow-xl" />

          {/* حبوب كبيرة الحجم وزوايا مختلفة ودوران محدد */}
          <img src="/beans.png" alt="" className="absolute top-[5%] left-[38%] w-32 -rotate-12 drop-shadow-2xl" />
          {/* حبة بدوران 60 درجة */}
          <img src="/beans.png" alt="" className="absolute top-[22%] left-[45%] w-36 rotate-60 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[38%] left-[49%] w-30 -rotate-90 drop-shadow-xl" />

          {/* حبوب صغيرة الحجم وزوايا مختلفة ودوران محدد */}
          <img src="/beans.png" alt="" className="absolute top-[8%] right-[32%] w-16 rotate-120 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[25%] right-[22%] w-18 rotate-15 drop-shadow-2xl filter blur-[1px]" />
          <img src="/beans.png" alt="" className="absolute top-[45%] right-[28%] w-14 rotate-60 drop-shadow-2xl" />
          {/* حبة بدوران 30 درجة */}
          ...
          {/* حبة إضافية منفرجة يسار بدوران 30 درجة */}
