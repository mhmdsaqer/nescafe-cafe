  ...
  return (
    <div className="relative w-full h-screen bg-[#C8683D] overflow-hidden flex flex-col justify-between text-white font-sans select-none">
      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        {/* الكأسان متداخلان وفي المنتصف */}
        <div className="relative z-10 flex items-end justify-center -space-x-28 md:-space-x-36 translate-y-20 md:translate-y-24">
          
          <img 
            src="/cup1.png" 
            alt="Pink Cream Frappe" 
            className="h-[82vh] w-auto max-w-none object-contain filter drop-shadow-[0_20px_25px_rgba(0,0,0,0.3)] z-10"
          />

          <img 
            src="/cup2.png" 
            alt="Chocolate Cream Frappe" 
            className="h-[82vh] w-auto max-w-none object-contain filter drop-shadow-[0_20px_25px_rgba(0,0,0,0.3)] z-20"
          />

        </div>
      </div>

      {/* 3. Bottom Curved White Section (الانحناءة المحدبة للأعلى) */}
      <div className="relative z-40 w-full">
        {/* مسار SVG ارتفاك المنحنى للأعلى في المنتصف */}
        ...
        {/* محتوى الشريط الأبيض */}
        <div className="bg-[#FAF7F2] text-stone-800 px-12 pb-6 pt-1 flex items-center justify-between shadow-2xl">
