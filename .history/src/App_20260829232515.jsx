  ...
  return (
    <div className="relative w-full h-screen bg-[#C8683D] overflow-hidden flex flex-col justify-between text-white font-sans select-none">
      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        {/* كلمة COFFEE بالخط العريض والضخم المتطابق مع التصميم */}
        <h1 
        ...
        {/* توزيع حبوب القهوة في الأماكن الدقيقة */}
        <div className="absolute inset-0 z-30 pointer-events-none">
          ...
          <img src="/beans.png" alt="" className="absolute top-[34%] left-[48%] w-24 -rotate-12 drop-shadow-2xl" />
        ...
        {/* المشروبان متجاوران بنفس الارتفاع */}
        <div className="relative z-20 flex items-end justify-center -space-x-10 translate-y-8">
          
          {/* المشروب الأيسر (الوردي) */}
          <img 
            src="/cup1.png" 
            alt="Pink Cream Frappe" 
            className="h-[65vh] w-auto max-w-none object-contain filter drop-shadow-[0_25px_30px_rgba(0,0,0,0.4)]"
          />

          {/* المشروب الأيمن (البني) */}
          <img 
            src="/cup2.png" 
      ...
      {/* 3. Bottom White Bar */}
      <div className="relative z-40 bg-[#FAF7F2] text-stone-800 rounded-t-[45px] px-12 py-5 flex items-center justify-between shadow-2xl -mt-6">
