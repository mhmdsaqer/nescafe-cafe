  ...
  return (
    <div className="relative w-full h-screen bg-[#DE7A4D] overflow-hidden flex flex-col justify-between text-white font-sans select-none">
      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        {/* كلمة COFFEE بالخط المطابق للتصميم الأصلي (Bebas Neue مشدود رأسياً ومتقارب الحروف) */}
        <h1 
          className="absolute text-[33vw] leading-none text-[#FAF7F2] z-0 pointer-events-none select-none -translate-y-6 tracking-[-0.04em] scale-y-[1.25] font-normal"
          style={{ 
