  ...
  return (
    <div className="relative w-full h-screen bg-[#DE7A4D] overflow-hidden flex flex-col justify-between text-white font-sans select-none">
      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        <h1 
          className="absolute text-[31vw] leading-none text-[#FAF7F2] z-0 pointer-events-none select-none -translate-y-16 tracking-[-0.01em] scale-y-[1.1]"
          style={{ 
        ...
        {/* توزيع حبوب القهوة الطائرة الاحترافي */}
        <div className="absolute inset-0 z-10 pointer-events-none">
          {/* حبوب كبيرة قريبة (تأثير عمق سينمائي مع Blur) */}
          <img src="/beans.png" alt="" className="absolute top-[8%] left-[8%] w-28 -rotate-45 drop-shadow-2xl filter blur-[1px]" />
          <img src="/beans.png" alt="" className="absolute top-[15%] right-[6%] w-32 rotate-12 drop-shadow-2xl filter blur-[1px]" />
          
          {/* حبوب في أعلى وأطراف النص */}
          <img src="/beans.png" alt="" className="absolute top-[5%] left-[32%] w-20 rotate-45 drop-shadow-xl" />
          <img src="/beans.png" alt="" className="absolute top-[18%] left-[44%] w-24 -rotate-12 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[6%] right-[34%] w-22 rotate-90 drop-shadow-xl" />

          {/* حبوب تتطاير حول الأكواب وفي المنتصف */}
          <img src="/beans.png" alt="" className="absolute top-[32%] left-[18%] w-24 rotate-30 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[48%] left-[27%] w-18 -rotate-60 drop-shadow-lg" />
          <img src="/beans.png" alt="" className="absolute top-[35%] left-[48%] w-26 rotate-180 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[28%] right-[24%] w-28 -rotate-45 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[46%] right-[16%] w-22 rotate-15 drop-shadow-xl" />
          <img src="/beans.png" alt="" className="absolute top-[60%] right-[32%] w-20 -rotate-90 drop-shadow-md" />
        </div>

        {/* الكأسان في المنتصف */}
        <div className="relative z-20 flex items-end justify-center -space-x-24 md:-space-x-32 translate-y-10 md:translate-y-14">
          <img 
            src="/cup1.png" 
            alt="Pink Cream Frappe" 
            className="h-[75vh] md:h-[82vh] w-auto max-w-none object-contain filter drop-shadow-[0_25px_35px_rgba(0,0,0,0.25)] z-10"
          />

          <img 
            src="/cup2.png" 
            alt="Chocolate Cream Frappe" 
            className="h-[75vh] md:h-[82vh] w-auto max-w-none object-contain filter drop-shadow-[0_25px_35px_rgba(0,0,0,0.25)] z-20"
          />
        </div>
      </div>

      {/* 3. Bottom Curved White Section (تم رفع المنحنى وقوسه بشكل ملحوظ) */}
      <div className="relative z-40 w-full">
        
        {/* المنحنى القوسي المرتفع جداً */}
        <div className="w-full overflow-hidden leading-none -mb-1">
          <svg 
            className="relative block w-full h-[220px] md:h-[280px]" 
            viewBox="0 0 1440 280" 
            preserveAspectRatio="none"
          >
            <path 
              d="M0,280 L0,170 Q720,-30 1440,170 L1440,280 Z" 
              fill="#FAF7F2"
            ></path>
          </svg>
        </div>
        ...
        <div className="bg-[#FAF7F2] text-stone-800 px-8 md:px-14 pb-8 pt-0 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
