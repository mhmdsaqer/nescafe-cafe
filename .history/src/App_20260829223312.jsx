...
import { Coffee, ShieldCheck, Heart, Sparkles, Star, MapPin, Phone, Instagram, Facebook } from 'lucide-react';
      ...
      <section id="hero" className="pt-24 min-h-screen flex items-center relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 w-full grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 z-10">
            ...
            <p className="text-coffee-muted text-lg max-w-lg leading-relaxed">
              انعش حواسك كل صباح مع تشكيلتنا المختارة من مشروبات النسكافيه المحضرة بكل شغف وعناية لتناسب يومك.
            </p>
            <div className="flex items-center gap-4 pt-4">
              <a href="#menu" className="bg-coffee-brand hover:bg-[#a94911] text-white px-8 py-3.5 rounded-full font-semibold shadow-lg shadow-coffee-brand/30 transition-all">
                استكشف القائمة
              </a>
          ...
          <div className="relative flex justify-center">
            <div className="absolute inset-0 bg-coffee-brand/10 rounded-full blur-3xl -z-10 scale-90"></div>
            <img 
              src="/hero.jpg" 
              alt="قهوة النسكافيه المميزة" 
              className="w-full max-w-lg rounded-2xl object-cover drop-shadow-2xl hover:scale-[1.02] transition-transform duration-300"
            />
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div>
            ...
            <div className="flex gap-4 text-white/70">
              <a href="#" className="hover:text-coffee-brand transition-colors"><Instagram className="w-6 h-6" /></a>
              <a href="#" className="hover:text-coffee-brand transition-colors"><Facebook className="w-6 h-6" /></a>
            </div>
          </div>
        </div>
