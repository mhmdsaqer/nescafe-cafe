  ...
  return (
    <div className="relative w-full h-screen bg-[#DE7A4D] overflow-hidden flex flex-col justify-between text-white font-sans select-none">
      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        {/* كلمة COFFEE تم رفعها للأعلى باستعمال -translate-y-16 */}
        <h1 
          className="absolute text-[33vw] leading-none text-[#FAF7F2] z-0 pointer-events-none select-none -translate-y-16 tracking-[-0.04em] scale-y-[1.25] font-normal"
          style={{ 
        ...
        {/* توزيع حبوب القهوة - تم تعديل الحجم والبعد بناءً على التركيز في الوسط */}
        <div className="absolute inset-0 z-10 pointer-events-none">
          {/* حبوب كبيرة الحجم قريبة جداً من الأكواب (التركيز في الوسط) */}
          <img src="/beans.png" alt="" className="absolute top-[35%] left-[45%] w-36 -rotate-12 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[45%] left-[50%] w-36 rotate-60 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[38%] left-[47%] w-30 -rotate-90 drop-shadow-xl" />
          <img src="/beans.png" alt="" className="absolute top-[30%] left-[42%] w-32 rotate-12 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[40%] left-[55%] w-36 rotate-75 drop-shadow-2xl" />

          {/* حبوب متوسطة الحجم أبعد قليلاً عن الأكواب (الوسط المحيط) */}
          <img src="/beans.png" alt="" className="absolute top-[25%] left-[38%] w-28 -rotate-45 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[48%] left-[27%] w-28 rotate-180 drop-shadow-2xl filter blur-[1px]" />
          <img src="/beans.png" alt="" className="absolute top-[55%] left-[35%] w-20 scale-x-[-1] rotate-45 drop-shadow-xl" />
          <img src="/beans.png" alt="" className="absolute top-[28%] right-[24%] w-28 -rotate-30 drop-shadow-2xl filter blur-[1px]" />
          <img src="/beans.png" alt="" className="absolute top-[45%] right-[28%] w-26 rotate-180 drop-shadow-2xl" />

          {/* حبوب صغيرة الحجم بعيدة جداً في الخلفية (الأطراف) */}
          <img src="/beans.png" alt="" className="absolute top-[12%] left-[18%] w-24 -rotate-45 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[8%] right-[32%] w-16 rotate-120 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[18%] right-[12%] w-12 rotate-30 drop-shadow-xl" />
          <img src="/beans.png" alt="" className="absolute top-[55%] right-[15%] w-16 -rotate-15 drop-shadow-2xl" />
          <img src="/beans.png" alt="" className="absolute top-[65%] left-[20%] w-14 scale-x-[-1] rotate-30 drop-shadow-lg" />
        </div>
