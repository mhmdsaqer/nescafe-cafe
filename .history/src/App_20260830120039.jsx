  ...
  return (
    <div className="relative w-full h-screen bg-[#DE7A4D] overflow-hidden flex flex-col justify-between text-white font-sans select-none">
      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        {/* كلمة COFFEE بتقليل المسافة بين الحروف */}
        <h1 
          className="absolute text-[28vw] leading-none text-[#FAF7F2] z-0 pointer-events-none select-none -translate-y-6 scale-y-[1.25] font-normal"
          style={{ 
            fontFamily: "'Bebas Neue', 'Impact', sans-serif",
            letterSpacing: '0.03em', // تم تقليل المسافة هنا (يمكنك تقليلها أكثر لـ 0.01em إذا أردت)
