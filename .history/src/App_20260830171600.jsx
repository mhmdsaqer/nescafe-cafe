...
const promosList = [
  {
    ...
    desc: "Get 20% off on any Large Cappuccino when ordered before 10 AM.",
    discount: "20% OFF",
    code: "MORNING20",
    image: "src/assets/coffee1.png",
  },
  {
    id: 2,
    title: "Bae Special Treat",
    desc: "Buy 1 Caramel Latte and get the second one at half price!",
  ...
  {
    id: 3,
    title: "Weekend Coffee Party",
    desc: "Enjoy free home delivery on all orders above $15 every weekend.",
...
export default function App() {
  ...
  return (
    <div className="w-full font-sans">
      ...
      {/* ================= PROMOS SECTION ================= */}
      <section id="promos" className="w-full bg-[#efe6dd] py-16 px-6 md:px-12">
        <div className="max-w-6xl mx-auto text-center space-y-3 mb-12">
          <h2 className="text-4xl font-extrabold text-[#3E2723] uppercase tracking-wide">
            SPECIAL PROMOTIONS
          </h2>
          <p className="text-gray-600 max-w-xl mx-auto text-sm md:text-base leading-relaxed">
            Take advantage of our exclusive offers, discounts, and daily deals tailored just for coffee lovers.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {promosList.map((promo) => (
            <div
              key={promo.id}
              className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 flex flex-col justify-between border border-gray-100 relative"
            >
              <div className="absolute top-4 left-4 bg-[#7e4222] text-white text-xs font-bold px-3 py-1 rounded-full z-10 shadow-sm">
                {promo.discount}
              </div>

              <div className="w-full h-48 bg-[#fdfbf7] flex items-center justify-center p-4">
                <img
                  src={promo.image}
                  alt={promo.title}
              ...
              <div className="p-6 flex flex-col flex-grow justify-between space-y-4">
                ...
                <div className="pt-2">
                  <div className="flex items-center justify-between bg-gray-50 border border-dashed border-gray-300 rounded-xl p-2">
                    <span className="font-mono font-bold text-sm text-[#7e4222] pl-2">
                      {promo.code}
                    </span>
                    <button
                      onClick={() => copyToClipboard(promo.code)}
                      className="bg-[#7e4222] hover:bg-[#63331a] text-white text-xs font-semibold px-3 py-1.5 rounded-lg transition-colors"
                    >
